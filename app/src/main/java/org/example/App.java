...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // The variable peekedDish should have a description of "A dish with a blue fish
        // pattern on it"
        Dish peekedDish = stack.peek();
        System.out.println("Peeked dish: " + peekedDish.description);

        // The variable poppedDish should have a description of "A dish with a blue fish
        // pattern on it"
        Dish poppedDish = stack.pop();
        System.out.println("Popped dish: " + poppedDish.description);

        // The variable anotherPoppedDish should have a description of "A dish with a
        // red fish pattern on it"
        ...
        System.out.println("Final size of stack: " + finalSize);

        stack.clear();
        System.out.println(stack.size());
        System.out.println(stack.peek()); // Should print a message that the stack is empty
    }
}
